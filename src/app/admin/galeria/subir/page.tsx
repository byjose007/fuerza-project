...
import { ArrowLeft, Upload, CheckCircle2, Image as ImageIcon, Loader2 } from 'lucide-react';
...
export default function SubirFotoPage() {
    ...
    return (
        <div className="p-8 max-w-3xl mx-auto">
            <Link href="/admin/galeria" className="inline-flex items-center text-gray-500 hover:text-[var(--color-brand-magenta)] mb-6 transition-colors font-medium">
                        ...
                        <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl overflow-hidden relative hover:bg-gray-50 transition-colors">
                            {preview ? (
                                <div className="space-y-1 text-center w-full">
                                    <img src={preview} alt="Vista previa" className="max-h-64 mx-auto rounded-lg object-contain shadow-sm mb-4" />
                                    <div className="flex text-sm text-gray-600 justify-center">
                                        <label htmlFor="file-upload" className="relative cursor-pointer bg-white rounded-md font-medium text-[var(--color-brand-magenta)] hover:text-magenta-500 focus-within:outline-none px-3 py-1 shadow-sm border border-gray-200">
